  ...
  return (
    <div className="about-page">
      ...
      <header className="about-hero">
        <span className="eyebrow">Established for the love of Egypt</span>
        <h1>
          The Story of <em>Khemet</em>
        </h1>
        <p>
          Khemet is the ancient name for Egypt itself — "the black land,"
          named for the fertile soil of the Nile. We borrowed it because
          that's exactly what we're here to help you find: the Egypt
          beneath the surface, not just the postcard.
        </p>
      </header>
      ...
      <section className="why-section">
        <div className="section-heading">
          <span className="eyebrow">Why Khemet</span>
        ...
        <div className="why">
          <div className="c">
            <div className="sv">
              <div className="svg seal">
                <svg width="33px" height="34px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 21C15.5 17.4 19 14.1764 19 10.2C19 6.22355 15.866 3 12 3C8.13401 3 5 6.22355 5 10.2C5 14.1764 8.5 17.4 12 21Z" stroke="#C9A84C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M12 12C13.1046 12 14 11.1046 14 10C14 8.89543 13.1046 8 12 8C10.8954 8 10 8.89543 10 10C10 11.1046 10.8954 12 12 12Z" stroke="#C9A84C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
              </div>
            </div>
      ...
      <section className="stats-band">
        <span className="eyebrow">Khemet in numbers</span>
...
<section className="team">
  <div className="section-heading">
    ...
    <h2>The people behind Khemet</h2>
  </div>
