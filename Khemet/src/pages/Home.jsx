    ...
    <main className="home">
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p className="hero-p">
            Discover timeless places. Plan unforgettable journeys across the
            land of pharaohs, pyramids and the eternal Nile.
          </p>
          ...
          <div className="linkat">
            ...
            {user?.role === "admin" && (
              <Link
                to="/"
                className="trip-btn home-btn"
                onClick={(e) => {
                  e.preventDefault();
                  showToast(
                    "error",
                    "This section isn't part of the admin responsibilities.",
                  );
                }}
              >
                <svg
      ...
      <section className="search-home">
        <div className="search-home-content">
          ...
          <p className="search-home-dit">
            Filter the map and feed by the experiences you crave.
          </p>
          <div className="search-tags">
            <div className="tag-card" onClick={() => goToTag("historical")}>
              <svg
              ...
              <div className="search-home-card-data">
                ...
                <p className="search-home-card-p">
            ...
            <div className="tag-card" onClick={() => goToTag("adventure")}>
              <svg
                className="line-svg search-home-line "
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="tag-card" onClick={() => goToTag("cultural")}>
              <svg
                className="line-svg search-home-line "
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="tag-card" onClick={() => goToTag("nature")}>
              <svg
                className="line-svg search-home-line "
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="featured">
        <div className="featured-header">
          <div className="featured-header-left">
            ...
            <p className="popular-det">
              What other explorers are saving this season.
            </p>
          </div>
          <Link className="ex-more" to="/map">
            <svg
              className="ex-more-svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
      ...
      <section className="trip-section">
        <div className="trip-section-cont">
          <img
            className="trip-section-pattern"
            alt=""
            aria-hidden="true"
            src={st}
          />
          <div className="trip-section-data">
            <p className="home-trip">
              {" "}
              <svg
                className="trip-section-svg"
                fill="#C9A84C"
                width="24px"
                height="24px"
                viewBox="0 0 256 256"
            ...
            <p className="trip-section-det">
              Tell us your interests and the days you have. We'll craft three
              personalized itineraries — balanced, adventurous and cultural.
            </p>
            {!user && (
            ...
            {user?.role === "user" && (
              <Link to="/trip-plan" className="tripsec-btn home-btn">
                Generate my trip
                <svg
                  className="gen-svg"
                  width="24"
            ...
            {user?.role === "admin" && (
              <Link
                to="/"
                className="tripsec-btn home-btn"
                onClick={(e) => {
                  e.preventDefault();
                  showToast(
                    "error",
