...
function TripPlanning({ booking, setBooking, nextStep, prevStep }) {
  ...
  return (
    <>
      <div className="booking-card">
        ...
        <p>
          Choose when your journey begins. Your itinerary dates will be
        ...
        <div className="flight-grid">
          ...
          <div>
            ...
            <input disabled value={`${itinerary.length} Days`} />
          </div>
        </div>
