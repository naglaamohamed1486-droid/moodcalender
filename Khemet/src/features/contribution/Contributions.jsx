...
import { deletePlaceImages } from "../../shared/utils/PicCache";
import PlaceCard from "./ContributionCard";
import Toast from "../../shared/components/Toast";
import "./Contributions.css";
import "./ContributionCard.css";
import { CATEGORIES, LOCATIONS, categoryLabel } from "./placesdatahandling";
...
export default function Contributions() {
  ...
  const statusCounts = {
    ...
    pending: contributions.filter((p) => (p.status || "pending") === "pending")
      .length,
  ...
  const handleLocationSearch = async () => {
    ...
    try {
      ...
      if (!matchedLocation) {
        setSearchError(
          "Location pinned — governorate not recognised, please select manually.",
        );
      } else if (!matchedCity) {
        setSearchError(
  ...
  const handleSave = async () => {
    ...
    const wasReviewed =
      editTarget.status === "approved" || editTarget.status === "rejected";
    ...
    try {
      ...
      showToast(
        "update",
        wasReviewed
          ? "Place updated & resent for admin review"
          : "Place updated",
      );
      closeEdit();
    } catch (err) {
  ...
  return (
    <main className="contributions-main">
      ...
      <div className="contributions-page">
        <Link to="/feed" className="au-back-link">
          ← Back to Community
        </Link>
        ...
        {contributions.length === 0 && (
          <div className="contributions-empty">
            ...
            <Link to="/addplace" className="contributions-empty-link">
        ...
        >
          <div className="ep-modal">
            <div className="ep-modal-header">
              ...
              <button className="ep-close" onClick={closeEdit}>
                ×
              </button>
            </div>
            ...
            <div className="ep-body">
              ...
              <section className="ep-section">
                ...
                <div className="ep-field">
                  ...
                  <input
                    className={`ep-input ${errors.title ? "ep-input-error" : ""}`}
                    name="title"
                    value={form.title}
                  ...
                  />
                  {errors.title && (
                    <span className="ep-error">{errors.title}</span>
                  )}
                </div>
                ...
                <div className="ep-field">
                  ...
                  <input
                    className={`ep-input ${errors.description ? "ep-input-error" : ""}`}
                    name="description"
                  ...
                  />
                  {errors.description && (
                    <span className="ep-error">{errors.description}</span>
                  )}
                </div>
                ...
                <div className="ep-field-row">
                  <div className="ep-field">
                    ...
                    {errors.category && (
                      <span className="ep-error">{errors.category}</span>
                    )}
                  </div>

                  <div className="ep-field">
                    <label className="ep-label">
                      RATING <span className="ep-label-hint">0 – 5</span>
                    </label>
                    <input
                      className="ep-input"
                      name="rating"
                ...
                <div className="ep-field">
                  <label className="ep-label">
                    TAGS{" "}
                    <span className="ep-label-hint">press Enter to add</span>
                  </label>
                  <div className="ep-tags-input">
                    ...
                    <input
                      ...
                      placeholder={
                        form.tags.length === 0 ? "nature, desert..." : ""
                      }
                    />
                  </div>
                </div>
              ...
              <section className="ep-section">
                ...
                <div className="ep-field-row">
                  <div className="ep-field">
                    ...
                    <select
                      className={`ep-input ep-select ${errors.governorate ? "ep-input-error" : ""}`}
                      name="governorate"
                    ...
                    {errors.governorate && (
                      <span className="ep-error">{errors.governorate}</span>
                    )}
                  </div>
                  ...
                  <div className="ep-field">
                    ...
                    <select
                      className={`ep-input ep-select ${errors.city ? "ep-input-error" : ""}`}
                      name="city"
                      value={form.city}
                      onChange={handleChange}
                    ...
                    {errors.city && (
                      <span className="ep-error">{errors.city}</span>
                    )}
                  </div>
                </div>
                ...
                <div className="ep-field">
                  <label className="ep-label">
                    COORDINATES{" "}
                    <span className="ep-label-hint">search to update pin</span>
                  </label>
                  ...
                  {searchError && (
                    <span className="ep-error">{searchError}</span>
                  )}
                  {(form.lat || form.lng) && (
              ...
              <section className="ep-section">
                <h3 className="ep-section-title">
                  Your Review{" "}
                  <span className="ep-section-optional">(optional)</span>
                </h3>
                <div className="ep-field">
            ...
            <div className="ep-footer">
              <button className="ep-cancel-btn" onClick={closeEdit}>
                Cancel
              </button>
        ...
        >
          <div className="ep-confirm">
            ...
            <p className="ep-confirm-body">
              This action can't be undone. The place will be permanently removed
