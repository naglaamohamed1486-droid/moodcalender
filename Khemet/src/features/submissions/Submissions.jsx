...
import { getPlaceImages } from "../../shared/utils/PicCache";
...
export default function Submissions() {
  ...
  return (
    <main className="Submissions">
      ...
      <p className="sub-det">
        Review community contributions. Approve to publish, or reject places
        that don't meet platform standards.
      </p>
          ...
          <div className="pf-linkat pf-linkat-pending">
            <div className="pf-linkat-data">
              <div className="pf-linkat-svg pf-linkat-svg-pending">
                ...
                >
                  <path
                    d="M8 3h8M8 21h8M8 3c0 4 4 5 4 8s-4 4-4 8M16 3c0 4-4 5-4 8s4 4 4 8"
                    stroke="#C9A84C"
                    strokeWidth="1.6"
                    strokeLinecap="round"
                    strokeLinejoin="round"
      ...
      <div className="sub-tabs">
        <div className="sub-tabs-cont">
          ...
          >
            <svg
              className="sub-tab-icon sub-tab-icon-stroke"
              width="18px"
              height="18px"
              viewBox="0 0 24 24"
              fill="none"
          ...
          >
            <svg
              className="sub-tab-icon sub-tab-icon-fill"
              fill="#7A6040"
              width="16px"
              height="16px"
              viewBox="0 0 32 32"
      ...
      <div className="sub-content">
        {loading ? (
          ...
          <div className="sub-cards-grid">
            {visible.map((place) => (
              <div
                key={`${place.ownerId}-${place.id}`}
                className="sub-card"
                data-status={place.status}
              >
                <div className="sub-card-img">
                  <SubmissionCardImage place={place} />
                  <span className="sub-card-category-badge">
                    {place.category}
                  </span>
                </div>
                ...
                <div className="sub-card-body">
                  ...
                  <p className="sub-card-owner">
                    Submitted by{" "}
                    {place.addedByname || place.addedByemail || place.ownerName}
                  </p>
                  {place.description && (
                  ...
                  {activeTab === "rejected" && (
                    <>
                      ...
                      {place.rejectionReason &&
                        editingReasonId !== place.id && (
                          <p className="sub-reason-preview">
                            "{place.rejectionReason}"
                          </p>
                        )}
                    </>
                ...
                <div className="sub-card-actions">
                  {activeTab === "pending" && (
                    <button
                      ...
                      onClick={() => setDetailsTarget(place)}
                    >
                      <svg
                        width="20px"
                        height="20px"
                  ...
                  {activeTab === "approved" && (
                    <button
                      className="sub-btn sub-btn-rereview"
                      onClick={() => handleReReview(place)}
                    >
